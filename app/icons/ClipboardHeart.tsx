export default function ClipboardHeartIcon({ className }: { className?: string }) {
    return (
        <svg
        ...
        >
            ...
            <path className='heart' d='M8.068 6.482c1.656-1.673 5.795 1.254 0 5.018-5.795-3.764-1.656-6.69 0-5.018Z' />
        </svg>
    )
}
